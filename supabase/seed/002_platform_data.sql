...
begin
  ...
  insert into public.app_settings(owner_id,section,values) values
    ...
    (v_owner,'outreach','{"dailyLimit":50,"dailyProactiveLimit":50,"hourlyLimit":8,"weekdays":[0,1,2,3,4,5,6],"startTime":"08:00","endTime":"22:00","minIntervalSeconds":5,"maxIntervalSeconds":5,"timezone":"America/Maceio","followUpsEnabled":false,"maxFollowUps":1,"followUpIntervalHours":72}'::jsonb),
