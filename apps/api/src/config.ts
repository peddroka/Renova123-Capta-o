...
const schema = z.object({
  ...
  EVOLUTION_PEDRO_INSTANCE_NAME: z.string().default("renova123-pedro"),
  ...
  EVOLUTION_PEDRO_WEBHOOK_SECRET: z.string().min(16).optional(),
  PEDRO_GLOBAL_PAUSE: booleanString(true),
  PEDRO_AUTOMATION_ENABLED: booleanString(false),
  PEDRO_OUTREACH_ENABLED: booleanString(false),
  PEDRO_REAL_SENDING_ENABLED: booleanString(false),
...
export const config = {
  ...
  PEDRO_WEBHOOK_SECRET: parsed.EVOLUTION_PEDRO_WEBHOOK_SECRET ?? parsed.EVOLUTION_WEBHOOK_SECRET ?? parsed.WEBHOOK_SECRET,
};
