# Graph Report - Renova123 Captação  (2026-08-15)

## Corpus Check
- 266 files · ~170,791 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1915 nodes · 3375 edges · 180 communities (151 shown, 29 thin omitted)
...
## Communities (180 total, 29 thin omitted)

### Community 0 - "worker/src/index.ts"
Cohesion: 0.07
Nodes (49): acquireInstanceLock(), applyFollowUpDecision(), auditTokenUsage(), conversationKey(), DeferredJobError, deliverGroupNotification(), ensureLatestInboundProcessing(), flagInboundForReview() (+41 more)

### Community 2 - "agent-decision-validator.ts"
Cohesion: 0.10
Nodes (20): AgentDecisionValidator, reconcileAction(), safeSlotReply(), validateCommercialClaims(), enforceCommercialFactuality(), extractExplicitLeadName(), APPROVED_SOCIAL_PROOF, CONFIRMED_PRODUCT_CATALOG (+12 more)
...
### Community 4 - "scripts"
Cohesion: 0.09
Nodes (22): scripts, build, db:validate, dev, dev:restart, dev:status, dev:stop, doctor (+14 more)
...
### Community 7 - "app.ts"
Cohesion: 0.06
Nodes (46): buildApp(), buildWolfLiveContext(), creatableResources, createAuthClient(), createServiceClient(), deletableResources, editableResourceKey(), ensureNoAppointmentConflict() (+38 more)
...
Cohesion: 0.09
Nodes (35): ConversationPlan, deduplicateUpdates(), extractDeterministicFacts(), extractLastQuestion(), fold(), inferCurrentTopic(), inferInterest(), memoryAnsweredTopics() (+27 more)
...
Cohesion: 0.13
Nodes (15): eligibleProviderOrder(), groqAttemptModels(), isSharedGroqQuotaError(), providerPoolRetrySeconds(), configuredGemini(), configuredGroq(), configuredOpenRouter(), cooldownRemainingSeconds() (+7 more)
...
Cohesion: 0.06
Nodes (32): action, default_icon, default_title, background, service_worker, type, content_security_policy, extension_pages (+24 more)
...
Cohesion: 0.14
Nodes (20): humanDisqualificationReason(), presenceState(), processInboundEvent(), regionFromPhone(), acceptedHeaders, cleanHeader(), CsvPreviewRow, guessDelimiter() (+12 more)
...
Cohesion: 0.17
Nodes (14): aiDecisionJsonSchema, AiStructuredOutputError, expandProviderDecision(), extractJsonObject(), JsonSchema, MEMORY_KEYS, parseAiDecision(), providerDecisionSchema (+6 more)
...
### Community 112 - "groq.ts"
Cohesion: 0.15
Nodes (14): callMetrics(), enrichQuotaDetails(), estimateTokens(), GroqCallMetrics, GroqHealth, GroqProvider, GroqRateLimitError, GroqRateLimits (+6 more)
...
### Community 117 - "core/src/index.ts"
Cohesion: 0.13
Nodes (14): AgentExecutionService, MaterialRecommendationService, normalize(), AgentCallMetrics, AgentExecutionInput, AgentExecutionResult, AgentMaterial, AgentMessage (+6 more)
...
Cohesion: 0.15
Nodes (25): activeWhatsApp(), api(), audioContexts, bind(), Call, cleanup(), esc(), finishCall() (+17 more)
...
### Community 128 - "francisco.test.ts"
Cohesion: 0.22
Nodes (4): baseSnapshot, GroqModel, GroqModelUnavailableError, GroqProviderError
...
Cohesion: 0.12
Nodes (17): concurrently, eslint, @eslint/js, devDependencies, concurrently, eslint, @eslint/js, @playwright/test (+9 more)
...
Cohesion: 0.18
Nodes (12): nextCommercialSlot(), processOutbound(), reconcileScheduledResume(), compareOutboundText(), materializeOutreachTemplate(), evaluateScheduledResume(), ScheduledResumeDecision, ScheduledResumeState (+4 more)

### Community 159 - "wolf-check.ts"
Cohesion: 0.67
Nodes (3): checks, main(), portOpen()

### Community 160 - "shared/src/index.ts"
Cohesion: 0.22
Nodes (7): AppointmentTool, HandoffTool, randomIntervalMs(), AiDecision, aiDecisionSchema, intents, OutreachSettings
...
### Community 163 - "interpretBrazilianContext"
Cohesion: 0.29
...
### Community 171 - "AgentContextBuilder"
Cohesion: 0.22
Nodes (5): AgentContextBuilder, item(), headers, main(), rows()

## Knowledge Gaps
- **578 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `printWidth`, `name` (+573 more)
...
- **Why does `EvolutionWhatsAppProvider` connect `EvolutionWhatsAppProvider` to `worker/src/index.ts`, `MockWhatsAppProvider`, `.qrFrom`, `app.ts`, `evolution.ts`, `WhatsAppProvider`, `whatsapp.ts`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `MockWhatsAppProvider` connect `MockWhatsAppProvider` to `worker/src/index.ts`, `app.ts`, `EvolutionWhatsAppProvider`, `WhatsAppProvider`, `whatsapp.ts`?**
